...
c---------------------------------------------------------------------
     ...
     >u(5,i,j,k) )
               ...
               d(5,2,i,j) = global_dt * 2.0d0 * tmp2 * u(2,i,j,k)
     > * ( global_tx1 * ( r43*c34 - c1345 )
     >   + global_ty1 * (     c34 - c1345 )
     >   + global_tz1 * (     c34 - c1345 ) )
               d(5,3,i,j) = global_dt * 2.0d0 * tmp2 * u(3,i,j,k)
     > * ( global_tx1 * ( c34 - c1345 )
     >   + global_ty1 * ( r43*c34 -c1345 )
     >   + global_tz1 * ( c34 - c1345 ) )
               d(5,4,i,j) = global_dt * 2.0d0 * tmp2 * u(4,i,j,k)
     > * ( global_tx1 * ( c34 - c1345 )
     >   + global_ty1 * ( c34 - c1345 )
     >   + global_tz1 * ( r43*c34 - c1345 ) )
               d(5,5,i,j) = 1.0d0
...
c---------------------------------------------------------------------
               ...
               a(1,1,i,j) = - global_dt * global_tz1 * global_dz1
               a(1,2,i,j) =   0.0d0
               a(1,3,i,j) =   0.0d0
               a(1,4,i,j) = - global_dt * global_tz2
               a(1,5,i,j) =   0.0d0

               a(2,1,i,j) = - global_dt * global_tz2
     >           * ( - ( u(2,i,j,k-1)*u(4,i,j,k-1) ) * tmp2 )
     >           - global_dt * global_tz1 * ( - c34 * tmp2 *
     >u(2,i,j,k-1) )
               a(2,2,i,j) = - global_dt * global_tz2 * ( u(4,i,j,k-1) *
     >tmp1 )
     >           - global_dt * global_tz1 * c34 * tmp1
     >           - global_dt * global_tz1 * global_dz2 
               a(2,3,i,j) = 0.0d0
               a(2,4,i,j) = - global_dt * global_tz2 * ( u(2,i,j,k-1) *
     >tmp1 )
               a(2,5,i,j) = 0.0d0

               a(3,1,i,j) = - global_dt * global_tz2
     >           * ( - ( u(3,i,j,k-1)*u(4,i,j,k-1) ) * tmp2 )
     >           - global_dt * global_tz1 * ( - c34 * tmp2 *
     >u(3,i,j,k-1) )
               a(3,2,i,j) = 0.0d0
               a(3,3,i,j) = - global_dt * global_tz2 * ( u(4,i,j,k-1) *
     >tmp1 )
     >           - global_dt * global_tz1 * ( c34 * tmp1 )
     >           - global_dt * global_tz1 * global_dz3
               a(3,4,i,j) = - global_dt * global_tz2 * ( u(3,i,j,k-1) *
     >tmp1 )
               a(3,5,i,j) = 0.0d0

               a(4,1,i,j) = - global_dt * global_tz2
     >        * ( - ( u(4,i,j,k-1) * tmp1 ) ** 2
     >            + global_c2 * qs(i,j,k-1) * tmp1 )
     >        - global_dt * global_tz1 * ( - r43 * c34 * tmp2 *
     >u(4,i,j,k-1) )
               a(4,2,i,j) = - global_dt * global_tz2
     >             * ( - global_c2 * ( u(2,i,j,k-1) * tmp1 ) )
               a(4,3,i,j) = - global_dt * global_tz2
     >             * ( - global_c2 * ( u(3,i,j,k-1) * tmp1 ) )
               a(4,4,i,j) = - global_dt * global_tz2 * ( 2.0d0 -
     >global_c2 )
     >             * ( u(4,i,j,k-1) * tmp1 )
     >             - global_dt * global_tz1 * ( r43 * c34 * tmp1 )
     >             - global_dt * global_tz1 * global_dz4
               a(4,5,i,j) = - global_dt * global_tz2 * global_c2

               a(5,1,i,j) = - global_dt * global_tz2
     ...
     >u(4,i,j,k-1)
               a(5,5,i,j) = - global_dt * global_tz2
...
c---------------------------------------------------------------------
               ...
               c(1,1,i,j) = - global_dt * global_tx1 * global_dx1
               c(1,2,i,j) = - global_dt * global_tx2
               c(1,3,i,j) =   0.0d0
               c(1,4,i,j) =   0.0d0
               c(1,5,i,j) =   0.0d0

               c(2,1,i,j) = - global_dt * global_tx2
     >          * ( - ( u(2,i-1,j,k) * tmp1 ) ** 2
     >       + global_c2 * qs(i-1,j,k) * tmp1 )
     >          - global_dt * global_tx1 * ( - r43 * c34 * tmp2 *
     >u(2,i-1,j,k) )
               c(2,2,i,j) = - global_dt * global_tx2
     >          * ( ( 2.0d0 - global_c2 ) * ( u(2,i-1,j,k) * tmp1 ) )
     >          - global_dt * global_tx1 * ( r43 * c34 * tmp1 )
     >          - global_dt * global_tx1 * global_dx2
               c(2,3,i,j) = - global_dt * global_tx2
     >              * ( - global_c2 * ( u(3,i-1,j,k) * tmp1 ) )
               c(2,4,i,j) = - global_dt * global_tx2
     >              * ( - global_c2 * ( u(4,i-1,j,k) * tmp1 ) )
               c(2,5,i,j) = - global_dt * global_tx2 * global_c2 

               c(3,1,i,j) = - global_dt * global_tx2
     >              * ( - ( u(2,i-1,j,k) * u(3,i-1,j,k) ) * tmp2 )
     >         - global_dt * global_tx1 * ( - c34 * tmp2 * u(3,i-1,j,k)
     >)
               c(3,2,i,j) = - global_dt * global_tx2 * ( u(3,i-1,j,k) *
     >tmp1 )
               c(3,3,i,j) = - global_dt * global_tx2 * ( u(2,i-1,j,k) *
     >tmp1 )
     ...
     >          - global_dt * global_tx1 * global_dx3
               ...
               c(4,1,i,j) = - global_dt * global_tx2
     >          * ( - ( u(2,i-1,j,k)*u(4,i-1,j,k) ) * tmp2 )
     >          - global_dt * global_tx1 * ( - c34 * tmp2 * u(4,i-1,j,k)
     >)
               c(4,2,i,j) = - global_dt * global_tx2 * ( u(4,i-1,j,k) *
     >tmp1 )
               c(4,3,i,j) = 0.0d0
               c(4,4,i,j) = - global_dt * global_tx2 * ( u(2,i-1,j,k) *
     >tmp1 )
     >          - global_dt * global_tx1 * ( c34 * tmp1 )
     >          - global_dt * global_tx1 * global_dx4
               c(4,5,i,j) = 0.0d0

               c(5,1,i,j) = - global_dt * global_tx2
     ...
     >              - c1345 * tmp2 * u(5,i-1,j,k) )
               c(5,2,i,j) = - global_dt * global_tx2
